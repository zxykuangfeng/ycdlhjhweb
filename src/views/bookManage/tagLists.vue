<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="标签名称" min-swidth="200px" align="center">
        <template slot-scope="scope">
    ...
    >
      ...
      >
        <el-form-item label="标签名">
          <el-input v-model="temp.ClassName" placeholder="请输入标签名" />
        </el-form-item>
...
<script>
import { getTag, addTag, updateTag, delTag } from '@/api/book'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      getTag(this.listQuery).then(res => {
        if (res.code == 0) {
          this.list = res.data
