...
export default {
  ...
  data() {
    return {
      ...
      currentMenu: 101,
      btnGroup: [
        { id: 101, btn_name: '首页主编推荐' },
        { id: 102, btn_name: '首页人气畅销' },
        { id: 103, btn_name: '首页新书速递' },
        { id: 104, btn_name: '首页经典必读' },
        { id: 105, btn_name: 'IP版权优质IP' },
        { id: 106, btn_name: 'IP版权推荐IP' },
        { id: 107, btn_name: 'IP版权影视IP' },
        { id: 108, btn_name: 'IP版权游戏IP' }
      ],
      multipleSelection: [],
      tableKey: 0,
      list: null,
