<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="所属道路" prop="mid" align="center" min-width="120px" />
      <el-table-column label="所属单位" prop="cid" align="center" min-width="120px" />
  ...
  const driving = new BMap.DrivingRoute(this.map, {
    ...
    onSearchComplete: (results) => {
      if (driving.getStatus() === BMAP_STATUS_SUCCESS) {
        ...
        const path = route.getPath(); // 获取路径点
